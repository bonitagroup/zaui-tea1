...
const ReferralPage: FC = () => {
    const inviteCode = "ZAUICOFFEE"; // placeholder, replace with real code/state if available
    ...
    return (
        <Page>
            ...
            <Box className="p-4 space-y-4">
                ...
                <Button fullWidth type="highlight">Chia sẻ mã mời</Button>

                <Box className="bg-white rounded-xl p-3 shadow-sm">
                    <Text size="xSmall" className="text-gray">Khi bạn bè đăng ký và đặt hàng, bạn sẽ nhận thưởng theo chương trình.</Text>
                </Box>
            </Box>
        </Page>
    );
